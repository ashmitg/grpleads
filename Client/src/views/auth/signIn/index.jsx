...
import {
  ...
  InputRightElement,
  Text,
  useColorModeValue,Grid, GridItem, useDisclosure,
} from "@chakra-ui/react";
import Add from 'views/admin/users/Add'

// Custom components
import DefaultAuth from "layouts/auth/Default";
// Assets
import illustration from "assets/img/auth/blank.png";
...
function SignIn() {
  console.log(process.env.GOOGLE_CLIENT_ID, "imported id")
  // Chakra color mode
        ...
        <Flex
          ...
          <form onSubmit={handleSubmit}>
            ...
            <FormControl isInvalid={errors.password && touched.password} mb="24px">
              ...
              <Text textAlign="center" color="gray.500" mb="12px">
                  Or
                </Text>
              <Button
                onClick={() => handleClick()}
                ...
                h='50'    // Set height to 50 (same as the Sign In button)
                bg='teal'
              >
                Register Account
              </Button>
