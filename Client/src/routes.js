...
const APIKEY = React.lazy(() => import("views/admin/APIKEY"));
...
const routes = [
  ...
  //   both: true,
  //   path: "/payments",
  //   icon: <Icon as={TbLockDollar} width='20px' height='20px' color='inherit' />,
  //   component: Payments,
  // },
 {
    name: "API",
    ...
    both: true,
    path: "/apikey",
    icon: <Icon as={FaKey} width='20px' height='20px' color='inherit' />,
    component: APIKEY,
  },
